        ...
        NavigationStack {
            Form {
                ...
                Section {
                    ...
                    Text("The app folder is visible in Files under On My iPhone > Scan to Me. Chosen folders can live in iCloud Drive or any file provider.")
                }
                Section("About") {
                    LabeledContent("Version", value: Bundle.main.object(forInfoDictionaryKey: "CFBundleShortVersionString") as? String ?? "-")
                    Text("Scan to Me appears on the printer only while the app is open and listening. iOS suspends network access in the background.")
